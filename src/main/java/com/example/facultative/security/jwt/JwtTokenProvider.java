...
import com.example.facultative.exceptions.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private long validatedInMillisecond;
    ...
    public String createToken(String username, Role role){
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + validatedInMillisecond);
